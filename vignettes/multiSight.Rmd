...
require(org.Mm.eg.db, warn.conflicts = FALSE)
...
multiOmicRes <- runMultiEnrichment(omicSignature = convFeat, 
                                   ...
                                   pvAdjust = "BH", #default value, optional
...
names(reacRes$result) # classical enrichment tables, multi-omics table, EMap
```
...
## Results
reacRes <- multiOmicRes$pathways$reactome
names(reacRes$result) # classical enrichment tables, multi-omics table and EMap
```
