...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-stable-ff69b4.svg)](https://www.tidyverse.org/lifecycle/#stable)
...
**multiSight** is an R package providing an user-friendly graphical interface to 
...
- To design _**Pathway**_ and _**gene ontology**_ **enrichment** 
